...
function centerContainer() {
    ...
    container.style.top = (document.documentElement.clientHeight / 2) - (bounds.height / 2) + 'px';
    // Set absolute left to be half of viewport width minus half of container width
    container.style.left = (document.documentElement.clientWidth / 2) - (bounds.width / 2) + 'px';
}
